...
class ChatWindow:
    def __init__(self, manager, container=None):
        ...
        self.panel = pygame_gui.elements.UIPanel(
            relative_rect=pygame.Rect((600, 50), (650, 620)),
        ...
        self.input_box = pygame_gui.elements.UITextEntryLine(
            relative_rect=pygame.Rect((5, 180), (390, 30)),  # inside the panel
            manager=self.manager,
            container=self.panel
        )
        self.input_box.hide()
    ...
    def _add_label(self, timestamp, message):
        ...
        scrollbar = self.chat_container.vert_scroll_bar
        scrollbar.set_scroll_from_start_percentage(100)
